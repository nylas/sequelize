...
AbstractQuery.prototype.isInsertQuery = function(results, metaData) {
  ...
  result = result && (this.sql.substring(0, 'insert into'.length).toLowerCase() === 'insert into');
...
AbstractQuery.prototype.isShowOrDescribeQuery = function() {
  ...
  result = result || (this.sql.substring(0, 'show'.length).toLowerCase() === 'show');
  result = result || (this.sql.substring(0, 'describe'.length).toLowerCase() === 'describe');
...
AbstractQuery.prototype.isCallQuery = function() {
  ...
  result = result || (this.sql.substring(0, 'call'.length).toLowerCase() === 'call');
